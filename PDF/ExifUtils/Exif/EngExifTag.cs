...
namespace PDF.ExifUtils.Exif
{
	...
	public enum EngExifTag : int
    {
        ...
        [ExifDataType(typeof(ExifTagCompression), EngExifType.UInt16)]
        Compression = 0x0103,

        [ExifDataType(typeof(ExifTagPhotometricInterpretation), EngExifType.UInt16)]

        [Description("Photometric Interpretation")]
        PhotometricInterpretation = 0x0106,

        [ExifDataType(typeof(ExifTagOrientation), EngExifType.UInt16)]
        Orientation = 0x0112,

        [Description("Samples Per Pixel")]
        SamplesPerPixel = 0x0115,

        [ExifDataType(typeof(ExifTagPlanarConfiguration), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagYCbCrPositioning), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagResolutionUnit), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(DateTime), EngExifType.Ascii)]
        [Description("DateStamp")]
        DateTime = 0x0132,

        [ExifDataType(EngExifType.Ascii)]
        ...
        [ExifDataType(typeof(ExifTagColorSpace), EngExifType.UInt16)]
        ColorSpace = 0xA001,
        ...
        [ExifDataType(typeof(ExifTagExposureProgram), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagMeteringMode), EngExifType.UInt16)]
        [Description("Metering Mode")]
        MeteringMode = 0x9207,

        [ExifDataType(typeof(ExifTagLightSource), EngExifType.UInt16)]
        [Description("Light Source")]
        LightSource = 0x9208,

        [ExifDataType(typeof(ExifTagFlash), EngExifType.UInt16)]
        Flash = 0x9209,
        ...
        [ExifDataType(typeof(ExifTagSensingMethod), EngExifType.UInt16)]
        [Description("Sensing Method")]
        SensingMethod = 0xA217,

        [ExifDataType(typeof(ExifTagFileSource), EngExifType.UInt16)]
        [Description("File Source")]
        FileSource = 0xA300,

        [ExifDataType(typeof(ExifTagSceneType), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagCustomRendered), EngExifType.UInt16)]
        [Description("Custom Rendered")]
        CustomRendered = 0xA401,

        [ExifDataType(typeof(ExifTagExposureMode), EngExifType.UInt16)]
        [Description("Exposure Mode")]
        ExposureMode = 0xA402,

        [ExifDataType(typeof(ExifTagWhiteBalance), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagSceneCaptureType), EngExifType.UInt16)]
        [Description("Scene Capture Type")]
        SceneCaptureType = 0xA406,

        [ExifDataType(typeof(ExifTagGainControl), EngExifType.UInt16)]
        [Description("Gain Control")]
        GainControl = 0xA407,

        [ExifDataType(typeof(ExifTagContrast), EngExifType.UInt16)]
        Contrast = 0xA408,

        [ExifDataType(typeof(ExifTagSaturation), EngExifType.UInt16)]
        Saturation = 0xA409,

        [ExifDataType(typeof(ExifTagSharpness), EngExifType.UInt16)]
        Sharpness = 0xA40A,

        [Description("Device Setting Description")]
        DeviceSettingDescription = 0xA40B,

        [ExifDataType(typeof(ExifTagSubjectDistanceRange), EngExifType.UInt16)]
        ...
        [ExifDataType(EngExifType.URational)]
        ...
        [ExifDataType(typeof(ExifTagGpsAltitudeRef), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagGpsDifferential), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagCleanFaxData), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagFillOrder), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagInkSet), EngExifType.UInt16)]
        [Description("Ink Set")]
        InkSet = 0x014C,
        ...
        [ExifDataType(typeof(ExifTagJPEGProc), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagPredictor), EngExifType.UInt16)]
        Predictor = 0x013D,
        ...
        [ExifDataType(typeof(ExifTagSampleFormat), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(ExifTagThreshholding), EngExifType.UInt16)]
        ...
        [ExifDataType(typeof(UnicodeEncoding), EngExifType.Byte)]
        [Description("Title")]
        MSTitle = 0x9C9B,
