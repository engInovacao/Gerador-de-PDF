...
namespace PDF.ExifUtils.Exif
{
    ...
    internal sealed class ExifDataTypeAttribute : Attribute
    {
        ...
        private EngExifType exifType = EngExifType.Unknown;
        ...
        public ExifDataTypeAttribute(EngExifType exifType)
        {
        ...
        /// <param name="exifType"></param>
        public ExifDataTypeAttribute(Type type, EngExifType exifType)
        {
            this.dataType = type;
            this.exifType = exifType;
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static EngExifType GetExifType(object value)
        {
            if (value == null)
                return EngExifType.Unknown;
