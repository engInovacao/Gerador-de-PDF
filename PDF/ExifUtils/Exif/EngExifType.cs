...
namespace PDF.ExifUtils.Exif
{
    ...
    public enum EngExifType
    {
        ...
        /// </summary>
        /// <remarks>If you set <see cref="EngExifProperty.Type">ExifProperty.Type</see> to <see cref="EngExifProperty.Type"/>, you should set the length data member to the length of the string including the NULL terminator. For example, the string HELLO would have a length of 6.</remarks>
        Ascii = 2,
